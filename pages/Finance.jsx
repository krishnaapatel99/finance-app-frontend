          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                {projects.map((p) => <option key={p.project_id}>{p.projectname}</option>)}
              </select>
            </div>
            ...
            <div className="flex bg-gray-100 rounded-lg p-1 w-fit">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium ${activeTab === "income" ? "bg-white shadow-sm text-blue-600" : "text-gray-600 hover:text-blue-500"}`}
              >
                Income
              </button>
              <button
                onClick={() => setActiveTab("expense")}
                className={`px-4 py-2 rounded-md text-sm font-medium ${activeTab === "expense" ? "bg-white shadow-sm text-blue-600" : "text-gray-600 hover:text-blue-500"}`}
              >
                Expense
              </button>
            </div>
